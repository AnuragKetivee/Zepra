...
pub enum RefreshRate {
    ...
    Hz144,
    Hz240,
    Hz360,   // Ultra-high refresh (gaming/racing)
    Hz480,   // Maximum smoothness
    Custom(u32),
}
...
impl RefreshRate {
    pub fn hz(&self) -> u32 {
        match self {
            ...
            RefreshRate::Hz360 => 360,
            RefreshRate::Hz480 => 480,
...
impl DisplayConfig {
    ...
    /// Ultra-fast 4K@240Hz for gaming and touch responsiveness
    pub fn uhd_4k_240hz() -> Self {
        Self {
            resolution: Resolution::UHD4K,
            refresh_rate: RefreshRate::Hz240,
            hdr_mode: HDRMode::HDR10Plus,
            color_space: ColorSpace::Rec2020,
            vsync: false,  // For lowest input latency
            max_frame_latency: 1,
            scaling_factor: 1.0,
        }
    }
    
    /// Full HD at 480Hz for ultra-smooth touch response
    pub fn fullhd_480hz() -> Self {
        Self {
            resolution: Resolution::FullHD,
            refresh_rate: RefreshRate::Hz480,
            hdr_mode: HDRMode::SDR,
            color_space: ColorSpace::SRGB,
            vsync: false,
            max_frame_latency: 1,
