...
pub struct TouchPoint {
    ...
    pub pressure: f32,
    /// Contact radius in pixels (for touch size)
    pub radius: f32,
    /// Whether this touch is detected as palm (for rejection)
    pub is_palm: bool,
    /// Touch type (finger, stylus, etc.)
        ...
        match event {
            Event::TouchStart { id, pos } => {
                self.active_touches.insert(*id, TouchPoint {
                    ...
                    pressure: 1.0,  // Default full pressure
