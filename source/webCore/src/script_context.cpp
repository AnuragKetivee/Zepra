...
void ScriptContext::setupWindowGlobals() {
    ...
    // =========================================================================
    // WebGL 2 API - Uses webgl_bindings.cpp (registered via WebGLBindings::registerNativeFunctions)
    // See: webCore/src/webgl_context.cpp for real OpenGL implementation
    // =========================================================================
